...
Route::post('/workorder-updatestatus', ['as' => 'workorder.update.task.status', 'uses' => 'backend\ServiceorderController@order_update_status']);
        ...
        Route::get('/reports-list', ['as' => 'reports.list', 'uses' => 'backend\ReportController@index']);
        ...
        Route::get('/service-report', ['as' => 'service.report', 'uses' => 'backend\ReportController@servicereport']);
        Route::post('/service-reportpost', ['as' => 'service.reportpost', 'uses' => 'backend\ReportController@servicereportpost']);
